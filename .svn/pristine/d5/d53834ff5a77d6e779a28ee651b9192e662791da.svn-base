...
namespace ETLCenter.ETLLoginService {
    ...
    public partial class ETLCenterLoginService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void ForgotPasswordAsync(string mailId) {
            this.ForgotPasswordAsync(mailId, null);
        }
        
        /// <remarks/>
        public void ForgotPasswordAsync(string mailId, object userState) {
            ...
            this.InvokeAsync("ForgotPassword", new object[] {
                        mailId}, this.ForgotPasswordOperationCompleted, userState);
        }
